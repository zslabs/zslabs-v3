...
2. Dotted-lines with Droplets that will stagger in and have the Droplets pop-in when each completes.
3. Smaller dots that will follow the upper-portion of the graph, fade away, and start over again.
