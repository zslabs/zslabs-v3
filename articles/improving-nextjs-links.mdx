...
I also use this as part of the [components](https://github.com/zslabs/zslabs-v3/blob/master/pages/articles/%5Bslug%5D.js#L29) I pass-through to [next-mdx-remote](https://github.com/hashicorp/next-mdx-remote) to transform Markdown links automatically.
