...
const Item = ({
  ...
  return (
    <Command.Item
      className="-mx-2 mt-1 flex h-10 cursor-pointer items-center gap-2 rounded-lg px-3 text-slate-12 transition-all duration-150 first:mt-2 aria-selected:bg-slate-3"
